...
pub fn render_section(frame: &mut Frame, area: Rect, section: &Section, focus_idx: usize, focused: bool) {
    let border_color = if focused { Color::Cyan } else { Color::DarkGray };
    match section {
        Section::KeyValue { title, items } => render_kv(frame, area, title, items, focus_idx, border_color),
        Section::Table { title, headers, rows } => render_table(frame, area, title, headers, rows, border_color),
        Section::Buttons { title, items } => render_buttons(frame, area, title, items, focus_idx, border_color),
...
fn render_kv(frame: &mut Frame, area: Rect, title: &str, items: &[KvItem], focus_idx: usize, border_color: Color) {
...
fn render_table(frame: &mut Frame, area: Rect, title: &str, headers: &[String], rows: &[Vec<String>], border_color: Color) {
...
fn render_buttons(frame: &mut Frame, area: Rect, title: &str, items: &[Button], focus_idx: usize, border_color: Color) {
