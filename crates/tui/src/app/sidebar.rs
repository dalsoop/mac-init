...
pub fn sidebar_move(items: &[SidebarItem], current: usize, dir: i32) -> usize {
    ...
    let has_selectable = items.iter().any(|i| !matches!(i, SidebarItem::GroupHeader(_)));
    if !has_selectable { return current; }
